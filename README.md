🇨🇿 Praga: 5 Giorni (Storia, Tech & Underground)
===============================================
[TOC]
...
# Giorno 1: Il Cuore Medievale & "Big Data" del 1400
*Focus: Citta' Vecchia, Astronomia e il Ghetto Ebraico.*
...
* **Castello di Praga (Hradčany):**
    ...
    * **Vicolo d'Oro (Zlatá ulička):** Le minuscole case degli artieri reali. Kafka visse al numero **22**.

### Pomeriggio (14:00 - 17:00)
* Scendi a piedi verso il quartiere **Malá Strana**.
* **Muro di John Lennon:** Un simbolo di protesta colorato e vivo.
* **La strada più stretta di Praga:**
    * 📍 *Dove:* Vicino al ristorante *Vinárna Čertovka* (U Lužického semináře).
...
* 🚌 **Viaggio:** Bus da **Nádraží Holešovice** (Linea per Litoměřice/Terezín). Durata ~50 min.
* **Memoriale di Terezin:**
    * Visita la **Piccola Fortezza** (prigione della Gestapo).
    * Visita il **Museo del Ghetto**.
    * *Nota:* È un'esperienza storicamente densa ed emotiva.
* *Rientro a Praga per pranzo.*

### Pomeriggio (15:00 - 18:00)
* **Città Nuova (Nové Město):** Passeggiata lungo il fiume.
* **Dancing House (Casa Danzante):** L'icona dell'architettura moderna (Frank Gehry).
* **Cripta dell'Operazione Anthropoid:**
    * 📍 *Dove:* Chiesa dei Santi Cirillo e Metodio (Resslova 9a).
...
### Mattina (09:30 - 12:30)
* **Stará čistírna odpadních vod (Old Wastewater Treatment Plant):**
    * 📍 *Indirizzo:* Papírenská 6, Praga 6 - Bubeneč.
    * 🕒 **Orari Tour:** Sabato e Domenica alle **10:00, 11:30, 13:30, 15:00**. (Nei giorni feriali i tour per singoli sono rari, controlla il sito web *staracistirna.cz*).
    * *Why:* Un complesso sotterraneo in mattoni rossi incredibile. Vedrai le enormi macchine a vapore del 1903 ancora funzionanti. Molto più interessante dei "Kolektory".

### Pomeriggio (14:00 - 17:00)
* **Galleria Nazionale (Veletržní Palác):**
    * 📍 *Dove:* Holešovice.
    * *Cosa:* Enorme collezione di arte moderna (Mucha, Klimt, Picasso, impressionisti).
    * *Alternativa Tech:* **Museo Tecnico Nazionale** (a Letná, poco distante). Consigliatissimo se preferisci aerei, treni e astronomia ai quadri.

### Sera (Il momento Hacker)
* **Brmlab (Hackerspace):**
...
### Mattina (10:00 - 13:00)
* **Piazza Venceslao:**
    * Il luogo simbolo della storia politica (Primavera di Praga 1968, Rivoluzione di Velluto 1989).
* **Museo Nazionale:**
    * Visita l'interno recentemente ristrutturato. La sala del Pantheon è maestosa.

### Pomeriggio
* **Lucerna Passage:**
    * Entra nella galleria (da via Vodičkova) per vedere la scultura **"Il Cavallo"** di David Černý (San Venceslao seduto sulla pancia di un cavallo morto appeso al soffitto).
* **Relax Finale:**
    * Caffè storico al **Café Louvre** (Národní 22). Era frequentato da Albert Einstein e Franz Kafka. Ottimo per un dolce finale.
...
| :--- | :--- | :--- |
| **Brmlab** | Pod Kapličkou 20, Praga 3 | **Martedì sera** (20:00+) è il top. |
| **Stará čistírna** | Papírenská 6, Praga 6 | Tour **Sab/Dom** (10:00, 11:30...). |
